(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["monadologia"] = factory();
	else
		root["monadologia"] = factory();
})(window, function() {
...
Object.defineProperty(exports, "__esModule", { value: true });
var pipe_1 = __webpack_require__(/*! ./util/pipe */ "./src/util/pipe.ts");
...
var Task_1 = __webpack_require__(/*! ./monad/Task */ "./src/monad/Task.ts");
exports.default = { pipe: pipe_1.default, curry: curry_1.default, go: go_1.default, compose: compose_1.default, maybe: Maybe_1.default, either: Either_1.default, state: State_1.default, writer: Writer_1.default, task: Task_1.default };
...
function eitherToMaybe(v) {
    return Maybe_1.default(v.catch(function (e) { return null; }).flatten());
}
var either = {
    right: right,
    left: left,
...
maybe.maybeToEither = function (v) {
    return v.isNothing() ? Either_1.default.left("no") : Either_1.default.right(v.flatten());
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var stateGen = function (rf) {
    return {
        runState: rf,
        map: function (f) {
            var runState = this.runState;
            return stateGen(function (state) {
...
var task = function (f) {
    return {
        ...
        map: function (f) {
            var _this = this;
            return task(function (err, ok) { return _this.fork(err, compose_1.default(ok, f)); });
        },
        chain: function (f) {
            var _this = this;
            return task(function (err, ok) { return _this.fork(err, function (x) { return f(x).fork(err, ok); }); });
        },
        flatten: function () {
...
task.resolve = function (x) {
    return task(function (_, ok) { return ok(x); });
};
...
var compose = function () {
    ...
    return function () {
        ...
        return fns.reduceRight(function (rest, fn) { return [fn.call.apply(fn, __spreadArrays([null], rest))]; }, args)[0];
    };
};
...
var curry = function (fn, length) {
    ...
    return function () {
        ...
        return args.length >= length ? fn.apply(void 0, args) : curry(function () {
            var nextArgs = [];
            for (var _i = 0; _i < arguments.length; _i++) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var pipe_1 = __webpack_require__(/*! ./pipe */ "./src/util/pipe.ts");
var go = function (init) {
    var fns = [];
    for (var _i = 1; _i < arguments.length; _i++) {
        fns[_i - 1] = arguments[_i];
    }
    return pipe_1.default.apply(void 0, fns)(init);
};
exports.default = go;
...
var pipe = function () {
    ...
    return function (v) { return fns.reduce(function (res, fn) { return fn(res); }, v); };
};
...
//# sourceMappingURL=monadologia.js.map